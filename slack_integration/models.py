...
class SlackIntegration(SingletonModel):
    ...
    access_token = models.CharField(max_length=50, blank=True, verbose_name=_('slack access token'))
    bot_name = models.CharField(max_length=30, blank=True, verbose_name=_('slack bot id'))
    bot_token = models.CharField(max_length=50, blank=True, verbose_name=_('slack bot token'))
